...
## [Lahoma](https://lahoma.com/)

It was kind of assitant application that helps people to design their home with digital assets, comes from furniture products. People were able to choose several styles of elements in a room - including floors, room styles (modern, classic, nature, industrial for example), and furnitures their products ( sofas, armchari, charis, fllor lamps, carpets, coffee tables, dinning tables etc)
